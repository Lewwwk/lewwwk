---
title: "Gettin’ it goin’ without goin’ under: cohesion and incipient instability."
date: 2008-01-03T13:36:00
draft: false
categories:
 - "Uncategorized"
tags:
...
These concepts are addressed in depth in Stafford Beer's [viable system model](http://en.wikipedia.org/wiki/Viable_System_Model) ([my reflections here](http://lewwwk.com2007/10/higlights-from-of-enterprise-viable.html) on reading [Heart of Enterprise](http://www.amazon.com/Heart-Enterprise-Classic-Beer/dp/0471948373/ref=sr_1_1?ie=UTF8&s=books&qid=1199076860&sr=8-1)) and are really about holding the tension between future (vision), and here and now (operations) \[see last post for [more on requisite attention](http://lewwwk.com2007/12/venturing-on-frontier-requisite.html)\]. Cohesion has a lot to do with articulating purpose as so well described by[ ]{style="text-decoration: underline;"}[Collins](http://en.wikipedia.org/wiki/James_C._Collins) and [Porras](http://en.wikipedia.org/wiki/Jerry_Porras) in [Building Your Company's Vision](http://harvardbusinessonline.hbsp.harvard.edu/b02/en/common/item_detail.jhtml?id=410X&referral=2340). And incipient instability is about monitoring trends in financials, plan performance, and relationship status (after all, ventures are systems, concentrated bundles of relationships), and then spotting changes that indicate that something is becoming instable in a way that could harm the cohesion of the system as a whole. 
