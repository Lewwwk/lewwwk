...
~~As we work on~~By launching [thread.io](http://thread.io) I've been pushed to figure out some sort of rationale for our 'readiness status'. In trying to balance our desire to iterate rapidly in public and at the same time indicate what users can expect from the service, here's what I think we're going to go with:
