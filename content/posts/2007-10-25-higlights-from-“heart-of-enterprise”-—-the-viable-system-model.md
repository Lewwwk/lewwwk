---
title: "Higlights from “Heart of Enterprise” — the Viable System Model"
...
A potentially helpful excerpt in terms of practical application in day-to-day decision making can be found [here](http://igniter.tumblr.com/post/17154546) but again the value will [likely ]{style="font-size:100%;"}[mostly ]{style="font-size:100%;"}[be lost without an immersion in the language, theory, and examples contained in the book.]{style="font-size:100%;"}
...
"[Fact]{style="font-weight: bold;"}: that which is the case."

"[Noise]{style="font-weight: bold;"}: A meaningless jumble of signals."

"[Data]{style="font-weight: bold;"}: statements of fact."

"[Information]{style="font-weight: bold;"}: that which CHANGES us."

"Data become information -- when the [fact ]{style="font-weight: bold;"}in them is susceptible to [action]{style="font-weight: bold;"}. How can I possibly know that I am [informed]{style="font-weight: bold;"}? --- Only because I have [changed my state]{style="font-style: italic;"}."
...
he has become skilled in recognizing a change in his own state, by recognizing information in the data flowing around him [and]{style="font-style: italic;"} in the ambient noise;
...
"... planning is a [continuous process]{style="font-style: italic;"}."
...
"...it is an act of decision carried out by managers empowered to commit resources to a different future. Planning is [not]{style="font-style: italic;"} an activity resulting in products called plans: it is a continuous process, whereby the process itself -- namely that of aborting the plans -- is the pay-off."
...
"... infinity is a [process]{style="font-style: italic;"}; thus to understand the process is to understand infinity without going there."

"First: there is a very real barrier to modeling the recursivity of viable systems more than one system beyond that over which we have authority. Second: no [finite]{style="font-style: italic;"} model is possible, because we do not have requisite variety to make it; and all we can do is to contemplate the [process]{style="font-style: italic;"} whereby such models are endlessly capable of generation. And that is to define the infinite recursion; and that is to explode into self-consciousness."
...
"But suppose that we can acquire data about stability that can be transformed into infomration (which changes us) about the possibility, the likelihood, of [incipient]{style="font-style: italic;"} instability: then, and only then, do we have a chance to avert it."
...
"It seems, may we not then say, that calm is a function of alertness. It comes from being [poised]{style="font-style: italic;"} to read the signs of incipient instability, in the quiet confidence that instability can be averted."
...
"It is only in the [infinite]{style="font-style: italic;"} recursion that self-consciousness occurs. It occurs for the man himself, of course... .The senior manager has to embody the self-consciousness of the institution; even if, unhappily, he does not yet know [himself]{style="font-style: italic;"}... "
...
"... viable organizations [produce themselves]{style="font-style: italic;"}."
