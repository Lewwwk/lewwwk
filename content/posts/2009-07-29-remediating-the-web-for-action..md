---
title: "Remediating the web for action."
date: 2009-07-29T15:11:25
draft: false
categories:
  - "Thoughts"
tags:
...
<a href="http://en.wikipedia.org/wiki/Image:10mm-aggregate.jpg"><img src="http://upload.wikimedia.org/wikipedia/en/thumb/e/e6/10mm-aggregate.jpg/300px-10mm-aggregate.jpg" title="10mm graded crushed rock or aggregate, for use..." decoding="async" width="240" height="180" alt="10mm graded crushed rock or aggregate, for use..." /></a>
...
[Twitter](http://twitter.com) however seems to be changing the game -- for the first time enabling many to actually reduce the number of sources they monitor for information and the number of destinations they post at. And it's also a universal place to have a conversation because the conversation doesn't happen in a destination, it happens in public, wherever people happen to be.

Couple this with a movement to open data sets, like the [Social Actions API](http://www.socialactions.com/developers), and I believe we are beginning to see a remediation of the great disintermediator that is the web.
...
3.  When I click on a that micro-url take me to the source, and offer up the context I need to evaluate the action through a header bar in the page itself (like [hootsuite](http://hootsuite.com) etc.). What I want to know are things like what is being said about the link generally, by my friends, and what it is related to. Give me the context quickly but do it in a way that doesn't take me away from the source.
...
Bottom-line, this would help surface actionable responses to any issue, make it easier for people to vet those actions on the fly, and increase speed and depth of actions taken on any issue. Interestingly, the pieces are mostly there, we just haven't connected them. I love the idea of [act.ly](http://act.ly/){rel="noopener noreferrer" target="_blank"} or [do.gd](http://do.gd/){rel="noopener noreferrer" target="_blank"} as micro-urls for social action. [SocialActions](http://socialactions.com) and more recently [AllforGood](http://allforgood.org) have launched social action datasets and API's. And finally some [SocialActions](http://socialactions.com) developers have created some base code for a header bar. Even the engines to filter, embed, and even enable new hashtags exists and what doesn't isn't particularly hard to create.
...
[![Reblog this post \[with Zemanta\]](http://img.zemanta.com/reblog_c.png?x-id=6a24d48f-a0d3-4636-8566-71afbfff3f53){.zemanta-pixie-img decoding="async" style="border: none; float: right;"}](http://reblog.zemanta.com/zemified/6a24d48f-a0d3-4636-8566-71afbfff3f53/ "Reblog this post [with Zemanta]"){.zemanta-pixie-a}
:::
:::::
