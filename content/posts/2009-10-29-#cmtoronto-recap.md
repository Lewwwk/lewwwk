...
[#cmToronto](http://search.twitter.com/search?q=%23cmToronto) opened on a gray Saturday morning with an introduction to [ChangeMedium](http://changemedium.org) and the day by [Michael Lewkowitz](http://twitter.com/igniter). [James Walker](http://twitter.com/walkah) followed up with an overview of what to expect during the hack session.  The orientation reminded participants that the opportunity is to take us out of our bubble and think about the reach, application, and implications of this medium for society.

Our first research presenter was [Hima Batavia](http://twitter.com/himabatavia), Research Assistant at the [McLaughlin-Rotman Centre for Global Health and Earth Institute](http://mrcglobal.org/) at Columbia University.  Her talk "Mobile Health: the Great Equalizer" focused on mobile health and showcased 7 examples including:

- Patient Mointoring: [Cell-Life](http://www.cell-life.org/)
- Adherence: [SIMpill](http://www.simpill.com/)
- Awareness: [textTOchange](http://www.texttochange.com/)
- Awareness: [Project Masiluleke](http://poptech.org/project_m)
- Data Collection: [RapidSMS](http://www.rapidsms.org/)
- HealthSystem: [FrontlineSMS](http://www.frontlinesms.com/)
- EmergencyResponse: [Ushahidi](http://www.ushahidi.com/)

Several questions came up after the presentation provoking both developers and researchers alike.

Up next, [Kayleigh Platz](http://twitter.com/write_girl), Technical Solutions Provider at the [University of Waterloo](http://uwaterloo.ca) shared her challenges of engaging in anthropological research in the area of culture and technology.  Her presentation "Culture and Technology" highlighted the groundbreaking nature of this medium and she concluded with the question of how can the research community support developers provoking discussion on the convergence of research and development -- a central theme to the future of ChangeMedium.
...
This recap of course would not be complete without a big thanks to [the participants](http://tr.im/cmToronto) and those who made it possible. #cmToronto was hosted by [SiG@MaRS](http://www.marsdd.com/About-MaRS/Partners/sig.html) and convened by [Ryan Coleman](http://twitter.com/ryancoleman), [Renjie Butalid](http://twitter.com/renjie), [Lisa Torjman](http://twitter.com/lisatorjman), and James Walker. ChangeMedium is also thankful for the deep support of [SiG@Waterloo](http://www.sig.uwaterloo.ca/) and the super-judo skills of [Peter Flaschner](http://twitter.com/flashlight), [Dan Williams](http://twitter.com/j_dan_williams), and [Joseph Dee](http://twitter.com/josephdee).

To get involved please visit: [tr.im/cmGroup](http://tr.im/cmGroup)

For:

- more information please visit: [ChangeMedium.org](http://changemedium.org)
