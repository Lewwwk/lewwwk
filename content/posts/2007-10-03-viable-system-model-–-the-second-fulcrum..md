---
title: "Viable System Model – the second fulcrum."
date: 2007-10-03T01:22:00
draft: false
categories:
 - "Thoughts"
aliases:
...
> ([Stafford Beer](http://en.wikipedia.org/wiki/Venture_capital)'s) [Viable Systems Model](http://en.wikipedia.org/wiki/Viable_System_Model), or VSM is a [model](http://en.wikipedia.org/wiki/Model_%28abstract%29 "Model (abstract)") of the organisational structure of any viable or [autonomous](http://en.wikipedia.org/wiki/Autonomous "Autonomous") [system](http://en.wikipedia.org/wiki/System "System"). A viable system is any system organised in such a way as to meet the demands of surviving in the changing environment. One of the prime features of systems that survive is that they are adaptable. The VSM expresses a model for a viable system, which is an abstracted cybernetic description that is applicable to any organisation that is a viable system and capable of autonomy.
