---
title: "Twitter and the emerging medium for change -> “What are you doing?”"
...
Already there are some great starts at the infrastructure ([SMOB](http://smob.sioc-project.org/), [FETHER](http://brdfdr.com/), [tr.im](http://blog.tr.im/post/165049236/tr-im-to-be-community-owned), [rsscloud](http://rsscloud.org), [laconi.ca](http://laconi.ca) etc), standards ([TwitterData](http://twitterdata.org), [MicroSyntax](http://microsyntax.org),etc.) and usage questions ([Kanter](http://beth.typepad.com/beths_blog/2009/04/twitter-for-activism-tool-vs-strategy-debate-and-a-new-twitter-activism-guide.html), [Bravo](http://www.netsquared.org/blog/britt-bravo/net2thinktank-how-can-nonprofits-use-twitter), [Wikipedia](http://en.wikipedia.org/wiki/Twitter), etc.). But we're just starting to scratch the service. Getting to the roots of this and how we can use it to make change needs a focus on social change and a coordinated strategy. Key tracks for that are:
...
- encouraging systems and standards that optimize the medium for public benefit (more on that in my [previous post](http://lewwwk.com/post428)).
