---
title: "Framing our future: SoCap09"
...
Since the last conference we've seen the depths of shifts underway in the financial system come along with continuing instability in our political and ecological systems. If we weren't clear last year the core systems of our society are in transition. And since last year's conference, we've seen the birth of t[he most accessible, participatory medium in history](http://lewwwk.com/post436) and the start of what [Om Malik](http://gigaom.com/author/om/) calls an [interaction society](http://omis.me/2009/04/14/what-twitter-broadband-internet-mean-to-me/). While it's great to see people working on shifting our existing institutions and systems, we're coming to this conference with a capacity for reinvention unlike any time in history.
...
This week's [#SoCap09](http://search.twitter.com/search?q=%23SoCap09) twitter chat should help kick that off. We'll be looking into the question of how is social media changing change? I'm curious to see what threads emerge and what we can take into the conversation at the conference.
